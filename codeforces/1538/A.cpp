...
void solve()
{
    ll n, a1 = 0, a2 = LLONG_MAX, a3 = 0, a4 = 0;
    sll(n);
    ll arr[n];
    REP(i, n)
    {
    ...
    // cout << (max(a3 + 1, a4 + 1)) << endl;

    // cout << max(n - a3, n - a4) << endl;

    // cout << (a4 + 1 + n - a3) << " " << (a3 + 1 + n - a4) << endl;

    ll ans = min({max(a3 + 1, a4 + 1), max(n - a3, n - a4), a3 + 1 + n - a4, a4 + 1 + n - a3});
    cout << ans << endl;
    // Output
